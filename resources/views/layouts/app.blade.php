...
<head>
    ...
    <!-- CSRF Token  © 2022 Copyright: RizkiLutfiandi  -->
        ...
        <nav class="navbar navbar-expand-md navbar-dark primary-color">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                    <a class="nav-link font-weight-bolder" href="{{url('transcation')}}">Point Of Sale                          
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('/transcation/history')}}">Histori Transaksi</a>
                    </li>
...
<!-- MDB core JavaScript //© 2022 Copyright: RizkiLutfiandi -->
